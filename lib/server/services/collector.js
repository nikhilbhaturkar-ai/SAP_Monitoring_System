...
import {
  ...
  writeWorkerDetails,
  writeJobDetails,
  writeCancelJobDetails,
  writeCertDetails,
  writeQueueErrorDetails,
  writeAuditFileDetails,
  writeSyslogDetails,
  writeTrfcDetails,
...
const DETAIL_EXTRACTORS = {
  ...
  sm37: { toRows: toJobDetails, write: writeJobDetails, argName: 'jobs' },
  cancel: {
    toRows: toCancelJobDetails,
    write: writeCancelJobDetails,
    argName: 'cancelledJobs',
  },
  strust: { toRows: toCertDetails, write: writeCertDetails, argName: 'certs' },
  strustToday: { toRows: toCertDetails, write: writeCertDetails, argName: 'certs' },
  strust15d: { toRows: toCertDetails, write: writeCertDetails, argName: 'certs' },
  smq1: { toRows: toQueueErrorDetails, write: writeQueueErrorDetails, argName: 'errors' },
  smq2: { toRows: toQueueErrorDetails, write: writeQueueErrorDetails, argName: 'errors' },
  sm20: { toRows: toAuditFileDetails, write: writeAuditFileDetails, argName: 'files' },
  sm21: { toRows: toSyslogDetails, write: writeSyslogDetails, argName: 'entries' },
  sm58: { toRows: toTrfcDetails, write: writeTrfcDetails, argName: 'trfcs' },
};
